...
//            new GeoPoint("Одесский музей западного и восточного искусства", GeoPoint.PointType.HOTEL,"description","text",new String[]{"muzey_zapadnogo1.jpg" , "10.jpg"},"10. Железный.mp3",46.482622, 30.743108)};
            new GeoPoint("Odessa Opera and Ballet Theater", GeoPoint.PointType.SHOWPLACE,"description","text",
                    new HashSet<String>(Arrays.asList(new String[]{"opera-theater.jpg","3650.JPG","caption.jpg"})),"10. Железный.mp3",46.485438, 30.741124),

            new GeoPoint("Odessa Philharmonic Theater", GeoPoint.PointType.SHOWPLACE,"description","text",
            ...
            new GeoPoint("steakhouse", GeoPoint.PointType.RESTAURAN,"description","text",
                    new HashSet<String>(Arrays.asList( new String[]{"timthumb.jpg",  "timthumb1.jpg"})),"10. Железный.mp3",46.484419, 30.735991),

            new GeoPoint("museum", GeoPoint.PointType.MUSEUM,"description","text",
...
//            new Guide(7,"Odessa", "description", "https://lh5.googleusercontent.com/K-4eyhQiumzugfnOKWa4ApRIvRzj90nQpD50rBC7uB-Fdnbh-qxN2mKML-hueLRDbaqDk2stq84=w1896-h874" , (byte) 5, "urlCash","mapCash",new Date())
           new Guide(Locale.ENGLISH,"Odessa", 46.46901973, 30.7406044, "The RecyclerView widget is a more advanced and flexible version of ListView. " +
           ...
           new Guide(Locale.ENGLISH,"Lviv",46.475137, 30.740480, "description", "https://lh3.googleusercontent.com/-7-3FPBNYa1I/VM6bDaMpWSI/AAAAAAAAEGc/Sq6xqZmzyKc/w280-h210-no/IMG_20140128_165152.jpg","https://lh3.googleusercontent.com/-uBoUoxp7UlI/UulvyaCs4FI/AAAAAAAABvM/-AsvxSpV6z0/w1148-h861-no/IMG_20140128_165152.jpg", (byte) 5, "urlCash","https://mega.co.nz/#!FEk2TIIb!rhlwEhAj-UC6KIsesfeqzqkyl560SbzSEhlvUu2_bEg",new Date()),
           new Guide(Locale.ENGLISH,"Kiev",46.475137, 30.740480, "description", "https://lh4.googleusercontent.com/-0KjaKBQABOw/VM6bDFsNdBI/AAAAAAAAEGU/pYdjBOsWHFU/w280-h210-no/IMG_20140712_065329.jpg","https://lh4.googleusercontent.com/-azMH99iPn54/U8EgSHUKp_I/AAAAAAAAC2o/dJSlhP1QDu4/w1148-h861-no/IMG_20140712_065329.jpg", (byte) 5, "https://mega.co.nz/#!FEk2TIIb!rhlwEhAj-UC6KIsesfeqzqkyl560SbzSEhlvUu2_bEg","dataCash",new Date()),
           new Guide(Locale.ENGLISH,"Ivano-Frankivsk",46.475137, 30.740480, "description", "https://lh3.googleusercontent.com/-bP5EKroOzj8/VM6bDjYgEbI/AAAAAAAAEGM/GGnCYfr9R_c/w280-h210-no/IMG_20140712_083445.jpg","https://lh6.googleusercontent.com/-Qwqhx0tlkoA/U8EgdZaBRcI/AAAAAAAAC3Y/UDbwxISQvNA/w1148-h861-no/IMG_20140712_083445.jpg", (byte) 5, "https://mega.co.nz/#!FEk2TIIb!rhlwEhAj-UC6KIsesfeqzqkyl560SbzSEhlvUu2_bEg","dataCash",new Date()),
           new Guide(Locale.ENGLISH,"Kharkiv",46.475137, 30.740480, "description", "https://lh3.googleusercontent.com/-NhZN8TI1HaQ/VM6bD-EBbEI/AAAAAAAAEGI/A-_a23ClueE/w280-h210-no/IMG_20140715_175055.jpg","https://lh5.googleusercontent.com/-2s5UEzq0cxU/U8ersgIt9sI/AAAAAAAADIw/c4AC9x1l8-Q/w1148-h861-no/IMG_20140715_175055.jpg", (byte) 5, "https://mega.co.nz/#!FEk2TIIb!rhlwEhAj-UC6KIsesfeqzqkyl560SbzSEhlvUu2_bEg","dataCash",new Date()),
           new Guide(Locale.ENGLISH,"name5",46.475137, 30.740480, "description", "https://lh5.googleusercontent.com/-KR0PhYddFZs/VM6bEBiYLEI/AAAAAAAAEGA/PzyujSmydbs/w280-h210-no/IMG_20140715_181906.jpg","https://lh3.googleusercontent.com/-dUXkS84RWOI/U8esAXMcSxI/AAAAAAAADLI/eCMHmYJEo1s/w1148-h861-no/IMG_20140715_181906.jpg", (byte) 5, "https://mega.co.nz/#!FEk2TIIb!rhlwEhAj-UC6KIsesfeqzqkyl560SbzSEhlvUu2_bEg","dataCash",new Date()),
           new Guide(Locale.ENGLISH,"TEST",46.475137, 30.740480, "description", "https://lh4.googleusercontent.com/--0rVSTj2r-0/VM6bER3WzBI/AAAAAAAAEGE/EjyYoJT8G4g/w280-h210-no/IMG_20140727_175532.jpg","https://lh4.googleusercontent.com/-hNqkIS-4yf8/U9UumpPQ8XI/AAAAAAAADcw/OTzsHi5g8X8/w1148-h861-no/IMG_20140727_175532.jpg", (byte) 5, "https://mega.co.nz/#!FEk2TIIb!rhlwEhAj-UC6KIsesfeqzqkyl560SbzSEhlvUu2_bEg","https://mega.co.nz/#!NJEHDZbC!_RnqWf-V0hPDfv43wAsUXRbBWi58QDh4-tgkh9v2AlI",new Date())
};
    public static void main(String[] args) {
//        ApplicationContext context = new AnnotationConfigApplicationContext(JavaConfig.class);
//        GuideRepository guideRepository = (GuideRepository)context.getBean("guideRepository");
//        ApplicationService service = (ApplicationService)context.getBean("service");
...
////         System.out.println(service.findAllGudes());
